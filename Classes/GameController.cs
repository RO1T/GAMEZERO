namespace DinoGoogle.Classes
{
    public static class GameController
    {
        ...
        {
            Road road = new(new PointF(0 + 100 * 9, 200), new Size(100, 17));
            roads.Add(road);
            countDangerSpawn++;
            ...
            if (countDangerSpawn >= dangerSpawn)
            {
                ...
                {
                    case 0:
                        Cactus cactus = new(new PointF(0 + 100 * 9, 150), new Size(50, 50));
                        cactuses.Add(cactus);
                        break;
                    case 1:
                        Bird bird = new(new PointF(0 + 100 * 9, 110), new Size(50, 50));
                        birds.Add(bird);
                        break;
                }
            }
        ...
        public static void GenerateRoad()
        {
            for (int i = 0; i < 10; i++)
            {
                Road road = new(new PointF(0 + 100 * i, 200), new Size(100, 17));
                roads.Add(road);
                countDangerSpawn++;
            }
        }
